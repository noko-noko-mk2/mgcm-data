...
DATA_FILES = [
    ...
    },
    {
      ...
      'columns': ['ステージ', '周回数', '魔法糸中', '魔法糸大', 'ベル', 'ジュエル', 'プレミアガチャチケット', 'SR以上限定プレミアガチャチケットのかけら', '1984いろは', '2061いろは', 'クッキングエプロンいろは', 'ホリデーカジュアルいろは', 'ラウンジウェアいろは', '1984花織', '2061花織', 'クッキングエプロン花織', 'ホリデーカジュアル花織', 'ラウンジウェア花織', '英気の破宝珠', '勇猛の破宝珠', '堅守の破宝珠', 'メダル枚数'],
      'stamina': 8,
    },
    {
      'name': '無尽ニンフ',
