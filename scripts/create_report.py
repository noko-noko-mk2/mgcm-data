...
DATA_FILES = [
    ...
    },
    {
      ...
      'columns': ['ステージ', '周回数', '魔法糸中', '魔法糸大', 'ベル', 'ジュエル', 'プレミアガチャチケット', 'SR以上限定プレミアガチャチケットのかけら', '1984セイラ', '2061セイラ', 'クッキングエプロンセイラ', 'ホリデーカジュアルセイラ', 'ラウンジウェアセイラ', '1984ここあ', '2061ここあ', 'クッキングエプロンここあ', 'ホリデーカジュアルここあ', 'ラウンジウェアここあ', '俊敏の破宝珠', '精密の破宝珠']
    },
    {
      'name': '無尽ニンフ',
